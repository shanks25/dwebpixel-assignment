    ...
    <nav class="container py-3 flex justify-between items-center">
        ...
        <div class="flex items-center gap-4">
            <a href="{{ route('admin.dashboard') }}" @class([
                ...
                'text-gray-900 hover:text-gray-800' => request()->routeIs(
                    'admin.dashboard'),
                'text-gray-700 hover:text-gray-600' => !request()->routeIs(
                    'admin.dashboard'),
            ])>
                Dashboard
            </a>
            <a href="{{ route('admin.skills.index') }}" @class([
                'transition-colors px-4',
                'text-gray-900 hover:text-grays-800' => request()->routeIs(
                    'admin.skills.index'),
                'text-gray-700 hover:text-grays-600' => !request()->routeIs(
                    'admin.skills.index'),
            ])>
                Skills
            </a>

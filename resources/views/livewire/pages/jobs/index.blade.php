                            ...
                            @forelse  ($jobs as $job)
                                <tr class="border-b dark:border-gray-700">
                                    ...
                                    <td class="px-4 py-3 text-center">
                                        <img src="{{ asset($job->company_logo) }}" class="h-12 w-auto block mx-auto"
                                            alt="{{ $job->company_name }}">
                                    </td>
                                    <td><span class="font-medium text-gray-900">{{ $job->company_name }}</span>
                                    </td>
                                    ...
                                    <td class="px-4 py-3">
                                        <div class="flex items-center flex-wrap gap-2">
                                            @foreach ($job->skills as $skills)
                                                <span
                                                    class="inline-block bg-gray-200 rounded-full px-2 py-0.5 text-xs font-medium text-gray-700">{{ $skills->name }}</span>
                                            @endforeach
                                        </div>
                                    </td>
                                    <td class="px-4 py-3">
